...
export default function UpdateCountry(props) {
  ...
  return (
    <>
      <>
        ...
        >
          ...
          <Modal.Body>
            ...
            <input type="text" name="name" defaultValue={country.name} ref={nameRef} />
          </Modal.Body>
          <Modal.Footer>
      ...
      {/* name: <input type="text" name="name" defaultValue={name} ref={nameRef} />
   <button onClick={()=>updateHandler(nameRef.current.value)}></button> */}
    </>
  );
}
